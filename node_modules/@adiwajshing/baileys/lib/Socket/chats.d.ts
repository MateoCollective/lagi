...
export declare const makeChatsSocket: (config: SocketConfig) => {
    ...
    relayMessage: (jid: string, message: proto.IMessage, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata }: import("../Types").MessageRelayOptions) => Promise<string>;
    ...
    groupInviteCode: (jid: string) => Promise<string>; /** update the profile picture for yourself or a group */
