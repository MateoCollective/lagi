...
export declare class InstaTouch {
    ...
    private auth_error;
    private headers;
    constructor({ url, download, filepath, filename, filetype, input, count, proxy, session, mediaType, scrapeType, asyncDownload, userAgent, progress, store_history, timeout, cli, endCursor, bulk, historyPath, zip, headers, }: Constructor);
